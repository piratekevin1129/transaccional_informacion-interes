...
$(document).ready(function(){
  ...
  var dias_disponibles_nuevos = [
      ...
      {
          dias:[6,7,8,9,10,11,12,13,14,16,18,20,21,23,24,25,28,30,31],
          mes:3,
          ano:2020
      },
      {
  ...
  setCalendario({
      ...
      buttons:true,
      actual:true,
      dias:dias_disponibles_nuevos
  })

  var fecha_actual = getCalendarioDate('calendar_1').split("/")[0]
  document.getElementById("getday").innerHTML = fecha_actual;
